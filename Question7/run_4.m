...
T=linspace(70000,230000,50); % 105370; %linspace(70000,200000,100); was used for the run
...
for counter=1:50 %counter=1:100 was used for the run
importgmt
nu=0.27;
E=110e9;
R=3389500;
...
lonLim =    [0 359.5 1];% [deg] min longitude, max longitude, resolution longitude (preferable similar to latitude)
...
Values=dV_obs7(5:end)-dV_airycorrected7(5:end);
y=rssq(Values)
RS(counter)=y;
...
% The best value using infinite plate seems to be 177.760 km of Te (min
% RS=3.2203e-10)
% The best value using thin shell, instead, is set to 115.710 km of Te!
% (min RS=2.2816e-10)
