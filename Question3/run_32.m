...
g=flip(g);
residual32=g_obs-g;
media=mean(residual32,"all")*1e5
maximum=max(residual32,[],"all")*1e5
normacheck=norm(g)/norm(g_obs)
residualsuit=convert(residual32);
...
for i=1:180
    for j=1:360
bound2_reshape32(i,j)= bound2_new(k);
k=k+1;
    end
end

%% Save data
save(['residual32.mat'],'residual32')
save(['crust_Binversion32'],'bound2_reshape32')
save(['trend_error32'],'trend32')


%% max value -19.97, min value -93.72.
%% functions
