...
g=flip(g);
residual31=g_obs-g;
media=mean(residual31,"all")*1e5
maximum=max(residual31,[],"all")*1e5
normacheck=norm(g)/norm(g_obs)
residualsuit=convert(residual31);
...
for i=1:180
    for j=1:360
bound2_reshape31(i,j)= bound2_new(k);
k=k+1;
    end
...
% Save data
save(['residual31.mat'],'residual31')
save(['crust_Binversion31'],'bound2_reshape31')
save(['trend_error31'],'trend31')


%% max value -20.62, min value -96.84.
%% functions
